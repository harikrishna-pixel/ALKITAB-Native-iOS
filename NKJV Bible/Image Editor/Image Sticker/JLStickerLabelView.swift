...
extension JLStickerLabelView: UITextViewDelegate {
    ...
    public func textViewDidChange(_ textView: UITextView) {
        if textView.text != "" {
            if labelTextView != nil {
                if labelTextView!.text.contains("Add Text") && labelTextView!.text.count == 9 {
                    labelTextView!.text = labelTextView!.text.replacingOccurrences(of: "Add Text", with: "")
                }
                adjustsWidthToFillItsContens(self)
...
//            print("beginBounds :",scaleRect)
        ...
        case .ended:
            ...
            print("text change ended")
//            MenuProtocol.delegateEditorAction!.RestoreAllStyle()
            self.refresh()
